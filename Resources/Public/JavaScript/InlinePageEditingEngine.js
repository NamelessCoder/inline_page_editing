...
define(['jquery'], function($) {
    ...
    InlinePageEditing.clickAction = function() {
    ...
    InlinePageEditing.initializeEditEnableListeners = function() {
        $(".inline-edit-click-enable").click(InlinePageEditing.clickAction);
    };
    ...
    InlinePageEditing.initializeWindowEvents = function() {
        window.addEventListener('message', function(e) {
            if (e.data[0] == 'setFrameHeight') {
                ...
                $('#' + e.data[1]).parent().removeClass('open').html(e.data[2]).click(InlinePageEditing.clickAction);
            }
        }, false);
    };
